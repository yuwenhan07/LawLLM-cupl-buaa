...
def data_process():
    ...
    for line in f1.readlines():
        try:
            ...
            original_cases.append(line.strip())
    ...
    return original_cases, processed_cases

if __name__ == '__main__':
    original_cases, processed_cases = data_process()

    # 输出处理前后的几条数据
    for original, processed in zip(original_cases[:3], processed_cases[:3]):
        print("处理前: ", original)
        print("处理后: ", processed)
        print("-----")