...
def process_func(example):
    ...
    # 构建指令和输入文本的序列
    instruction_text = (
        f"<|system|>\n请对下面给的这篇法律文书提取摘要，用更短、更连贯、更自然的文字表达其主要内容。<|endoftext|>\n<|user|>\n{example['input']}<|endoftext|>\n<|assistant|>\n"
    )
...
# 加载数据集
input_path = "../data/legal-js-files/test.jsonl"
train_dataset_path = "../data/legal-js-files/LTS_train_origin.jsonl"
test_dataset_path = "../data/legal-js-files/LTS_test_origin.jsonl"
split_jsonl_file(input_path, train_dataset_path, test_dataset_path)

train_jsonl_new_path = "../data/legal-js-files/LTS_train.jsonl"
test_jsonl_new_path = "../data/legal-js-files/LTS_test.jsonl"
...
swanlab_callback = SwanLabCallback(
    project="GLM4-LTS-fintune",
    experiment_name="GLM4-9B-Chat",
    description="使用智谱GLM4-9B-Chat模型法律文本摘要上微调。",
    config={
        "model": "GLM4-9B-Chat",
        "dataset": "法律文本摘要",
    },
