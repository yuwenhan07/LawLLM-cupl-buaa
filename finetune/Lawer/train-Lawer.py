...
def process_func(example):
    ...
    # 构建指令和输入文本的序列
    instruction_text = (
        f"<|system|>\n假设你是一名律师，请回答下面这个真实情景下的中文法律咨询问题。<|endoftext|>\n<|user|>\n{example['input']}<|endoftext|>\n<|assistant|>\n"
    )
...
# 加载数据集
input_path = "../data/legal-lc-files/test.jsonl"
train_dataset_path = "../data/legal-lc-files/Lawer_train_origin.jsonl"
test_dataset_path = "../data/legal-lc-files/Lawer_test_origin.jsonl"
split_jsonl_file(input_path, train_dataset_path, test_dataset_path)

train_jsonl_new_path = "../data/legal-lc-files/Lawer_train.jsonl"
test_jsonl_new_path = "../data/legal-lc-files/Lawer_test.jsonl"
...
swanlab_callback = SwanLabCallback(
    ...
    description="使用智谱GLM4-9B-Chat模型作为律师回答法律咨询问题。",
    config={
        "model": "GLM4-9B-Chat",
        "dataset": "律师法律咨询",
    },
